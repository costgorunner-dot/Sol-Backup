...
create_backup() {
    ...
    # CRITICAL: Remove credential files - NEVER backup these!
    find backup/skills -name ".backup-credentials" -type f -delete 2>/dev/null || true
    find backup/skills -name ".backup-config.json" -type f -delete 2>/dev/null || true
    find backup/skills -name "*.pem" -type f -delete 2>/dev/null || true
    find backup/skills -name "*credentials*" -type f -delete 2>/dev/null || true
